...
% This Code is imlementation of article which proposed Ali Þenol and Hacer
% Karacan. Please if you use the code cite the papaer below:
% Þenol, A , Karacan, H . (2019). Kd-tree and adaptive radius (KD-AR Stream) based real-time data stream clustering . 
